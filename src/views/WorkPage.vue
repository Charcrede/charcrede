...
<template>
    <article class="lg:mt-48 xs:mt-24 lg:px-56 xs:px-8 relative flex flex-col lg:gap-32 xs:gap-16">
        <h2 class="lg:text-[3rem] xs:text-[1.5rem] text-center font-semibold font-clash lg:mb-8 xs:mb-0 text-white">
            Quelques projets</h2>
        <img :src="require('../assets/Star-1.svg')" alt=""
            class="absolute top-[10%] left-0 -z-10 lg:w-48 lg:h-48 xs:w-24 xs:h-24 rotate">
        <img :src="require('../assets/One-Forth-Ellipse.svg')" alt=""
            class="absolute top-[5%] left-2/4 -z-10  lg:w-24 lg:h-24 xs:w-16 xs:h-16 scale">
        <img :src="require('../assets/Waves_2.svg')" alt=""
            class="absolute top-1/2 right-0 -z-10 lg:w-48 lg:h-48 xs:w-24 xs:h-24">
        <img :src="require('../assets/Star-3.svg')" alt=""
            class="absolute top-[45%] right-1/4 -z-10  lg:w-24 lg:h-24 xs:w-16 xs:h-16 rotate">
        <img :src="require('../assets/Half-Shape_2_inverted.svg')" alt=""
            class="absolute top-1/4 right-[2%] -z-10 lg:w-48 lg:h-48 xs:w-24 xs:h-24 scale">
        <img :src="require('../assets/Small-Elipse.svg')" alt=""
            class="absolute top-[50%] left-[2%] -z-10 lg:w-48 lg:h-48 xs:w-24 xs:h-24 translate">
        <img :src="require('../assets/Square_1.svg')" alt=""
            class="absolute top-[68%] left-[32%] -z-10 lg:w-48 lg:h-48 xs:w-24 xs:h-24 bounce">
        <img :src="require('../assets/Star-1.svg')" alt=""
            class="absolute top-[78%] right-[12%] -z-10 lg:w-48 lg:h-48 xs:w-24 xs:h-24 rotate">
        <img :src="require('../assets/bar_3.svg')" alt=""
            class="absolute top-[95%] right-[12%] -z-10 lg:w-48 lg:h-48 xs:w-24 xs:h-24 translate">
        <img :src="require('../assets/Small-Elipse.svg')" alt=""
            class="absolute -bottom-[5%] left-[5%] -z-10  lg:w-24 lg:h-24 xs:w-16 xs:h-16 scale">
        ...
        <img :src="require('../assets/Eye2.svg')" alt=""
            class="absolute -bottom-[18%] right-1/4 -z-10  lg:w-24 lg:h-24 xs:w-16 xs:h-16 bounce">
        ...
        <section class="text-white">
            <figure class="lg:flex-row xs:flex-col-reverse flex xs:gap-0 lg:gap-8 items-center justify-between">
                <div class="lg:w-3/5 xs:w-full group relative">
                    <swiper :slides-per-view="1" :space-between="50" class="rounded-2xl w-full">
                        <swiper-slide>
                    ...
                    <div
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-60 h-60"
                ...
                <div class="lg:w-2/5 xs:w-full lg:text-right xs:text-left">
                    ...
                    <figcaption class="lg:text-[2.5rem] xs:text-[1.25rem] font-clash">
                        Transfert d'<span class="font-semibold">argent</span> en toute <span
                            class="font-semibold">sécurité</span> dans la zone de l' <span
                            class="font-semibold">UEMOA</span>
                    </figcaption>
                    <span class="text-[#aaaaaa] lg:text-2xl xs:text-xl">
                        Entreprise, Edoutech
                    </span>
        ...
        <section class="text-white">
            <figure class="lg:flex xs:block gap-8 items-center justify-between">
                <div class="lg:w-2/5 xs:w-full text-left">
                    ...
                    <figcaption class="lg:text-[2.5rem] xs:text-[1.25rem] font-clash">
                        <span class="font-semibold">Amusez</span> vous à <span class="font-semibold">casser des briques
                        </span>
                    </figcaption>
                    <span class="text-[#aaaaaa] lg:text-2xl xs:text-xl">
                        Site web, Charcre-bailse
            ...
            <figure class="lg:flex-row xs:flex-col-reverse flex xs:gap-0 lg:gap-8 items-center justify-between">
                <div class="lg:w-3/5 xs:w-full group relative">
                    ...
                    <div
                        ...
                        <span
                            class="flex justify-center items-center gap-8 text-[2rem] font-clash font-semibold text-[#aaa]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#aaa" class="h-24 w-24">
                                <path
